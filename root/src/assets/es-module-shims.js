(function () {
  ...
  const n = t.fetch ? globalHook(t.fetch) : fetch;
  ...
  const se = t.onpolyfill
    ? globalHook(t.onpolyfill)
    : () =>
        console.log(
  ...
  const globalHook = (e) => (typeof e === "string" ? self[e] : e);
  ...
  const fromParent = (e) => (e ? ` imported from ${e}` : "");
  const de = /\\/g;
  function isURL(e) {
  ...
  function resolveAndComposeImportMap(e, t, r) {
    ...
    if (e.scopes)
      for (const a in e.scopes) {
        const n = resolveUrl(a, t);
        resolveAndComposePackages(
          e.scopes[a],
          s.scopes[n] || (s.scopes[n] = {}),
          t,
          r
        );
      }
  ...
  function resolveAndComposePackages(e, t, s, a) {
    for (const n in e) {
      ...
      f
        ? (t[i] = f)
        : console.warn(`Mapping "${n}" -> "${e[n]}" does not resolve`);
    }
  }
  let pe;
  window.addEventListener("error", (e) => (pe = e));
  function dynamicImportScript(e, { errUrl: t = e } = {}) {
    pe = void 0;
        ...
        if (self._esmsi) {
          ...
          a(
            (!(n instanceof Event) && n) ||
              (pe && pe.error) ||
              new Error(
                `Error loading or executing the graph of ${t} (check the console for ${r}).`
              )
          );
          pe = void 0;
        }
  ...
  const ye = Promise.resolve(he).then((e) => {
    if (e) {
      ...
      return Promise.all([
        be(createBlob("import.meta")).then(() => (we = true), noop),
        ce &&
          be(createBlob('import"data:text/css,{}"assert{type:"css"}')).then(
            () => (me = true),
            noop
          ),
        le &&
          be(createBlob('import"data:text/json,{}"assert{type:"json"}')).then(
            () => (ke = true),
            noop
          ),
        new Promise((e) => {
  ...
  function parse(e, t = "@") {
    (Ue = e), (Ie = t);
    const r = 2 * Ue.length + (2 << 18);
    if (r > Oe || !Se) {
      for (; r > Oe; ) Oe *= 2;
      ($e = new ArrayBuffer(Oe)),
        Ce(Ae, new Uint16Array($e, 16, 85)),
        (Se = (function (e, t, r) {
          "use asm";

          const s = new e.Int8Array(r);
          const a = new e.Int16Array(r);
          const n = new e.Int32Array(r);
          const i = new e.Uint8Array(r);
          const c = new e.Uint16Array(r);
          let f = 992;
          function b(e) {
            e |= 0;
            let t = 0;
                      ...
                      case 41: {
                        ...
                        if (
                          (r << 16) >> 16 != 0
                            ? ((se =
                                n[
                                  ((n[60] | 0) + (((r & 65535) + -1) << 2)) >> 2
                                ] | 0),
                              (n[(se + 20) >> 2] | 0) ==
                                (n[((n[59] | 0) + ((t & 65535) << 2)) >> 2] |
                                  0))
                            : 0
                        ) {
                          t = (se + 4) | 0;
          ...
          function k() {
            ...
            e: do {
              if ((i | 0) == 3) {
                ...
                } else if ((i | 0) == 34) t = w(1) | 0;
                e = n[61] | 0;
                if (
                  (t << 16) >> 16 == 102 ? (m((e + 2) | 0, 52, 6) | 0) == 0 : 0
                ) {
                  n[61] = e + 8;
                  u(c, w(1) | 0);
                  break;
          ...
          const Q = () =>
            (((n[((n[49] | 0) + 8) >> 2] | 0) - (n[3] | 0)) >> 1) | 0;
          const R = () =>
            (((n[((n[50] | 0) + 4) >> 2] | 0) - (n[3] | 0)) >> 1) | 0;
          function T(e) {
            e |= 0;

            return ((e << 16) >> 16 == 13) | ((e << 16) >> 16 == 10) | 0;
          }
          const V = () => (((n[n[49] >> 2] | 0) - (n[3] | 0)) >> 1) | 0;
          const W = () => (((n[n[50] >> 2] | 0) - (n[3] | 0)) >> 1) | 0;
          const X = () => i[((n[49] | 0) + 24) >> 0] | 0 | 0;
          function Y(e) {
            e |= 0;
            n[3] = e;
          }
        ...
        })(typeof self !== "undefined" ? self : global, {}, $e)),
        (Le = Se.su(Oe - (2 << 17)));
    }
    const s = Ue.length + 1;
    Se.ses(Le),
      Se.sa(s - 1),
      Ce(Ue, new Uint16Array($e, Le, s)),
      Se.p() || ((Me = Se.e()), o());
    const a = [];
    const n = [];
    for (; Se.ri(); ) {
      ...
      let c;
      Se.ip() &&
        (c = b(s === -1 ? e : e + 1, Ue.charCodeAt(s === -1 ? e - 1 : e))),
        a.push({ n: c, s: e, e: t, ss: n, se: i, d: s, a: r });
    }
    for (; Se.re(); ) {
      const e = Se.es();
      const t = Ue.charCodeAt(e);
      n.push(t === 34 || t === 39 ? b(e + 1, t) : Ue.slice(Se.es(), Se.ee()));
    }
  ...
  function b(e, t) {
    ...
    for (;;) {
      Me >= Ue.length && o();
      const e = Ue.charCodeAt(Me);
      if (e === t) break;
      e === 92
        ? ((r += Ue.slice(s, Me)), (r += k()), (s = Me))
        : (e === 8232 || e === 8233 || (u(e) && o()), ++Me);
    }

    return (r += Ue.slice(s, Me++)), r;
  }
  function k() {
    let e = Ue.charCodeAt(++Me);
    switch ((++Me, e)) {
      case 110:
        return "\n";
      case 114:
      ...
      case 117:
        return (function () {
          let e;
          Ue.charCodeAt(Me) === 123
            ? (++Me,
              (e = l(Ue.indexOf("}", Me) - Me)),
              ++Me,
              e > 1114111 && o())
            : (e = l(4));
      ...
      default:
        if (e >= 48 && e <= 55) {
          let t = Ue.substr(Me - 1, 3).match(/^[0-7]+/)[0];
          let r = parseInt(t, 8);
  ...
  function l(e) {
    ...
    return (s !== 95 && Me - t === e) || o(), r;
  }
  const u = (e) => e === 13 || e === 10;
  function o() {
    throw Object.assign(
      Error(
        `Parse error ${Ie}:${Ue.slice(0, Me).split("\n").length}:${
          Me - Ue.lastIndexOf("\n", Me - 1)
        }`
      ),
      { idx: Me }
  ...
  const Pe = a
    ? async (e, t) => {
        ...
        return r
          ? { r, b: !resolveIfNotPlainOrUrl(e, t) && !isURL(e) }
          : _resolve(e, t);
      }
    : _resolve;
  async function importShim(e, ...t) {
    let a = t[t.length - 1];
    typeof a !== "string" && (a = ue);
    await Ne;
    s && (await s(e, typeof t[1] !== "string" ? t[1] : {}, a));
    if (Te || r || !Re) {
      processImportMaps();
      r || (Te = false);
    }
    ...
    return topLevelLoad((await Pe(e, a)).r, { credentials: "same-origin" });
  }
  self.importShim = importShim;
  const defaultResolve = (e, t) =>
    resolveImportMap(Ee, resolveIfNotPlainOrUrl(e, t) || e, t) ||
    throwUnresolved(e, t);
    ...
    if (!r)
      if (
        ...
        for (const t of document.querySelectorAll(
          ...
          } else t.type === "module" && (e = true);
      }
    Re =
      t.polyfillEnable !== true &&
      ve &&
      we &&
      ge &&
      (!le || ke) &&
          ...
          if (t.type === "childList")
            for (const e of t.addedNodes)
              if (e.tagName === "SCRIPT") {
                ...
                e.type === (r ? "importmap-shim" : "importmap") &&
                  processImportMap(e);
              } else
                e.tagName === "LINK" &&
                  e.rel === (r ? "modulepreload-shim" : "modulepreload") &&
                  processPreload(e);
  ...
  async function topLevelLoad(e, t, a, n, i) {
    r || (Te = false);
    await _e;
    s && (await s(id, typeof args[1] !== "string" ? args[1] : {}, parentUrl));
    if (!r && Re) {
      if (n) return null;
      await i;

      return be(a ? createBlob(a) : e, { errUrl: e || a });
    }
    ...
    await i;
    if (a && !r && !c.n && true) {
      const e = await be(createBlob(a), { errUrl: a });
    ...
    const te = await be(r || c.n || !n ? c.b : c.u, { errUrl: c.u });
  ...
  const urlJsString = (e) => `'${e.replace(/'/g, "\\'")}'`;
  let Fe;
  function resolveDeps(e, t) {
    ...
    const [r] = e.a;
    const s = e.S;
    let a = fe && Fe ? `import '${Fe}';` : "";
    if (r.length) {
      let f = 0;
      let te = 0;
      const re = [];
      function pushStringTo(t) {
        while (re[re.length - 1] < t) {
          const t = re.pop();
          a += `${s.slice(f, t)}, ${urlJsString(e.r)}`;
          f = t;
        }
        a += s.slice(f, t);
        f = t;
      }
      for (const { s: se, ss: ae, se: ne, d: ie } of r)
        if (ie === -1) {
          const oe = e.d[te++];
          let ce = oe.b;
          const le = !ce;
          le &&
            ((ce = oe.s) ||
              (ce = oe.s =
                createBlob(
                  `export function u$_(m){${oe.a[1]
                    .map((e) =>
                      e === "default" ? "d$_=m.default" : `${e}=m.${e}`
                    )
                    .join(",")}}${oe.a[1]
                    .map((e) =>
                      e === "default"
                    ...
                    .join(";")}\n//# sourceURL=${oe.r}?cycle`
                )));
          pushStringTo(se - 1);
          a += `/*${s.slice(se - 1, ne)}*/${urlJsString(ce)}`;
          if (!le && oe.s) {
            a += `;import*as m$_${te} from'${oe.b}';import{u$_ as u$_${te}}from'${oe.s}';u$_${te}(m$_${te})`;
            oe.s = void 0;
          }
          f = ne;
        } else if (ie === -2) {
      ...
      pushStringTo(s.length);
    } else a += s;
    let n = false;
    a = a.replace(
      He,
      (t, r, s) => ((n = !r), t.replace(s, () => new URL(s, e.r)))
    );
    n || (a += `\n//# sourceURL=${e.r}`);
    e.b = Fe = createBlob(a);
    e.S = void 0;
  ...
  const De = /^(text|application)\/json(;|$)/;
  const Je = /^(text|application)\/css(;|$)/;
  const Ke =
    /url\(\s*(?:(["'])((?:\\.|[^\n\\"'])+)\1|((?:\\.|[^\s,"'()\\])+))\s*\)/g;
  const ze = [];
  let Ge = 0;
  ...
  async function doFetch(e, t, r) {
    ...
    try {
      ...
      t.message = `Unable to fetch ${e}${fromParent(
        r
    ...
    if (!a.ok)
      throw Error(`${a.status} ${a.statusText} ${a.url}${fromParent(r)}`);
  ...
  async function fetchModule(e, t, r) {
    ...
    if (qe.test(a)) return { r: s.url, s: await s.text(), t: "js" };
    if (De.test(a))
      ...
      return {
        ...
        s: `var s=new CSSStyleSheet();s.replaceSync(${JSON.stringify(
          (await s.text()).replace(
            Ke,
            (t, r = "", s, a) => `url(${r}${resolveUrl(s || a, e)}${r})`
          )
        )});export default s;`,
        t: "css",
      };
  ...
  function getOrCreateLoad(e, t, s, a) {
    ...
    n.f = (async () => {
      if (!a) {
        let i;
        ({ r: n.r, s: a, t: i } = await (Xe[e] || fetchModule(e, t, s)));
        if (i && !r) {
          if ((i === "css" && !ce) || (i === "json" && !le))
            throw Error(
              `${i}-modules require <script type="esms-options">{ "polyfillEnable": ["${i}-modules"] }<\/script>`
            );
          ((i === "css" && !me) || (i === "json" && !ke)) && (n.n = true);
        }
      }
      try {
        n.a = parse(a, n.u);
    ...
    n.L = n.f.then(async () => {
      ...
      n.d = (
        await Promise.all(
          n.a[0].map(async ({ n: t, d: r }) => {
            ((r >= 0 && !ve) || (r === 2 && !we)) && (n.n = true);
            if (r !== -1 || !t) return;
            const { r: s, b: a } = await Pe(t, n.r || n.u);
            !a || (ge && !je) || (n.n = true);
            if (c && c.test(s)) return { b: s };
            e.integrity && (e = { ...e, integrity: void 0 });
  ...
  function processScriptsAndPreloads() {
    for (const e of document.querySelectorAll(
      r ? "script[type=module-shim]" : "script[type=module]"
    ))
      processScript(e);
    for (const e of document.querySelectorAll(
      r ? "link[rel=modulepreload-shim]" : "link[rel=modulepreload]"
    ))
      processPreload(e);
  }
  function processImportMaps() {
    for (const e of document.querySelectorAll(
      r ? 'script[type="importmap-shim"]' : 'script[type="importmap"]'
    ))
      processImportMap(e);
  }
  ...
  function domContentLoadedCheck() {
    --Ve !== 0 || ne || document.dispatchEvent(new Event("DOMContentLoaded"));
  }
  ...
  function readyStateCompleteCheck() {
    --We !== 0 || ne || document.dispatchEvent(new Event("readystatechange"));
  }
  ...
  function processScript(e) {
    if (e.ep) return;
    if (e.getAttribute("noshim") !== null) return;
    ...
    t && We++;
    s && Ve++;
    const a = e.getAttribute("async") === null && t;
    const n = topLevelLoad(
      e.src || ue,
      getFetchOpts(e),
      !e.src && e.innerHTML,
      !r,
